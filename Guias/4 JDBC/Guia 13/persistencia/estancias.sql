...
Select id_familia, nombre From familias Where num_hijos > 2 And edad_maxima < 11;
SELECT * FROM casas WHERE fecha_desde > DATE('2020-06-01') and DATE('2020-07-31'); 
SELECT * FROM familias WHERE email LIKE '%@hotmail%';
Select c.*, ca.* From clientes c inner join estancias e on c.id_cliente = e.id_cliente
