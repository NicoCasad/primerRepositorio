...
INSERT INTO personajes(nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) VALUES("Bruce Banner", "Hulk", 160, "600mil", 75, 98, 1962, "Fisico Nuclear", 1);
INSERT INTO personajes(nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) VALUES("Tony Stark", "Iron Man", 170, "200mil", 70, 123, 1963, "Inventor Industrial", 1);
...
INSERT INTO personajes(nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) VALUES("Wanda Maximoff", "Bruja Escarlata", 170, "100mil", 90, 345, 1964, "Bruja", 1);
INSERT INTO personajes(nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) VALUES("Carol Danvers", "Capitana Marvel", 157, "250mil", 85, 128, 1968, "Oficial de Inteligencia", 1);
...
INSERT INTO personajes(nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) VALUES("Peter Parker", "Spiderman", 165, "25mil", 80, 74, 1962, "Fotografo", 1);
...
INSERT INTO personajes(nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) VALUES("Bobby Drake", "Ice Man", 140, "2mil", 64, 122, 1963, "Contador", 1);
INSERT INTO personajes(nombre_real, personaje, inteligencia, fuerza, velocidad, poder, aparicion, ocupacion, id_creador) VALUES("Barry Alen", "Flash", 160, "10mil", 120, 168, 1956, "Cientifico Forense", 2);
...
UPDATE personajes
SET id_personaje = id_personaje - 1
WHERE id_personaje > 10;
